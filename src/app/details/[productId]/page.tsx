  ...
  return (
    <main className='product-details container'>
      <div className="box column">
        <section className="product-info box full-width ai-start">
          <div className="product-images box small-gap full-width" style={{ alignItems: "stretch" }}>
        ...
        <section className="box column full-width">
          <Comments comments={comments} title='Rating And Reviews' />
        </section>

        <section className="box column product-list">
